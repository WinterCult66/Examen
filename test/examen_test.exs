defmodule Examen.ExamenTest do
  ...
  describe "# EXAMEN MULTIPLES TEST'S" do
    ...
    test "#get_books_with_author_2/0 Validate the 5 rows in Join all tables Where is Success", %{
      autor: _,
      book: _,
      library: _
    } do
    ...
    test "#delete_library/1 Delete the library due the  hasn't relation ==> True", %{
      library2: library2
    } do
