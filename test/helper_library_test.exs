defmodule Examen.HelperLibraryTest do
  ...
  describe "# START DATA" do
    ...
    test "HelperLibrary.update_library Validate == True", %{library: library} do
      ...
      assert {:ok, %Library{} = library_u} =
               HelperLibrary.update_library(library_load, %{category: "xxx"})
    end
    ...
    test "HelperLibrary.delete_library Validate == True", %{library: library} do
      HelperLibrary.delete_library(library)
      assert true
    end
  end
end
